      ...
      <div className="mb-6">
        <nav className="flex space-x-4" aria-label="Tabs">
          <button
            ...
            className={`px-4 py-2 text-sm font-medium rounded-md ${activeSection === "verification" ? 'bg-blue-100 text-blue-700' : 'text-gray-600 hover:text-gray-800 hover:bg-gray-100'}`}
          >
