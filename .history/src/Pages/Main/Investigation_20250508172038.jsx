  ...
  return (
    <div className="max-w-7xl mx-auto p-4">
      ...
      <form onSubmit={handleFormSubmit}>
              ...
              {activeSection === "taxpayer" && (
                <div className="flex flex-col space-y-3">
                  ...
                  <CustomButton
                    ...
                    className="w-full bg-gray-200 hover:bg-gray-300 text-gray-800 px-6 py-3 rounded-md font-medium transition-colors shadow-sm"
                  >
                    Back to Listing
                  </CustomButton>
                </div>
        ...
        <div className="mt-8 hidden lg:flex justify-end space-x-4">
          <CustomButton
            type="button"
            onClick={handleBackToListing}
            className="bg-gray-200 hover:bg-gray-300 text-gray-800 px-8 py-3 rounded-md font-medium transition-colors shadow-sm"
          >
            Back to Listing
          </CustomButton>
          <CustomButton
