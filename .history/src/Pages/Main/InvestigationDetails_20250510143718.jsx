            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-xl font-semibold text-gray-900">
                  Investigation in Respect of <span className='text-blue-600'>{investigation.taxpayers[0].trade_name}</span> having GSTIN <span className='text-blue-600'>{investigation.taxpayers[0].gstin}</span>
                </h1>
