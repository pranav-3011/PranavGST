            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-xl font-semibold text-gray-900">
                  Investigation in respect of <span className='bg-blue-100 px-2 rounded-sm'><span className='text-blue-400'>{investigation.taxpayers[0].trade_name}</span></span> having GSTIN <span className='bg-blue-100 px-2 rounded-sm'><span className='text-[#00256c]'>{investigation.taxpayers[0].gstin}</span></span>
                </h1>
