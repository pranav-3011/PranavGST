              ...
              <div>
                ...
                <div className="flex items-center gap-2 text-sm text-gray-600">
                  ...
                  <span className={`px-2 py-0.5 rounded-full text-xs font-medium ${
                    investigation.status === 'under_investigation' ? 'bg-green-100 text-green-800' :
                    investigation.status === 'transferred' ? 'bg-gray-100 text-gray-800' :
                    investigation.status === 'ir_issue' ? 'bg-yellow-100 text-yellow-800' :
                    investigation.status === 'scn_issued'? 'bg-blue-100 text-blue-800':
