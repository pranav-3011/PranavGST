            ...
            <div className="space-y-4">
              ...
              <div className="hidden md:block">
                <div className="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-lg p-4 border border-blue-100 shadow-sm">
                  <label className="flex items-center gap-2 text-base font-medium text-blue-700 mb-3">
                    ...
                    <div className="relative">
                      ...
                      <div className="relative">
                        ...
                        <input
                          type="date"
                          name="from_date"
                          className="w-full pl-10 border border-blue-200 bg-white rounded-md px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all"
