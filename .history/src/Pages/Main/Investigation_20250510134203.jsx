            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <InputBox
                  ...
                  label="File No."
                  type="text"
                  className=" py-1.5 border border-gray-50 rounded-md focus-within:border-[#00256c] "
                ...
                <InputBox
                  ...
                  type="text"
                  className="w-full py-1.5 border border-gray-50 rounded-md focus:outline-none focus:ring-1  focus:border-[#00256c] "
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full border border-gray-600 rounded-sm px-3 py-1.5  focus:outline-none focus:ring-1  focus:border-[#00256c] "
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full border border-gray-800 rounded-sm px-3 py-1.5  focus:outline-none focus:ring-1  focus:border-[#00256c] "
