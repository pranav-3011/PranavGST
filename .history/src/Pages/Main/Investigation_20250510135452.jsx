            ...
            <div className="space-y-4">
              ...
              {formData.source === "Other" && (
                <div>
                  ...
                  <input
                    ...
                    onChange={handleChange}
                    className="w-full py-1.5 border border-gray-50 rounded-md focus-within:border-[#00256c] px-3"
                    required
                  />
                </div>
              )}
              ...
              <div>
                ...
                <textarea
                  ...
                  rows="3"
                  className="w-full border border-gray-400 rounded-md px-3 py-2 focus:outline-none focus:ring-1 focus:border-[#00256c]"
