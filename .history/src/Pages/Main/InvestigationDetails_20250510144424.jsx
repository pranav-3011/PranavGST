              ...
              <div className="bg-white rounded-sm shadow-sm border border-gray-200">
                ...
                <div className="p-4">
                  <div className="grid grid-cols-3 gap-4">
                    <div className="flex items-center justify-between p-3 bg-gray-50/50 rounded-sm border border-gray-100">
                      <p className="text-xs text-gray-500">File Number</p>
                      <p className="text-xs text-gray-900">{investigation.file_number || '-'}</p>
                    </div>
                    <div className="flex items-center justify-between p-3 bg-gray-50/50 rounded-sm border border-gray-100">
                      <p className="text-xs text-gray-500">Date of Detection</p>
                      <p className="text-xs text-gray-900">{investigation.date_of_detection ? new Date(investigation.date_of_detection).toLocaleDateString() : '-'}</p>
                    </div>
                    <div className="flex items-center justify-between p-3 bg-gray-50/50 rounded-sm border border-gray-100">
                      <p className="text-xs text-gray-500">Period Involved</p>
                      <p className="text-xs text-gray-900">{investigation.period_involved}</p>
                    </div>
                    <div className="flex items-center justify-between p-3 bg-gray-50/50 rounded-sm border border-gray-100">
                      <p className="text-xs text-gray-500">Assigned Officer</p>
                      <p className="text-xs text-gray-900">{investigation.currently_assigned_officer || '-'}</p>
                    </div>
                    <div className="flex items-center justify-between p-3 bg-gray-50/50 rounded-sm border border-gray-100">
                      <p className="text-xs text-gray-500">E-Office File No.</p>
                      <p className="text-xs text-gray-900">{investigation.e_office_file_no || '-'}</p>
                    </div>
                    <div className="flex items-center justify-between p-3 bg-gray-50/50 rounded-sm border border-gray-100">
                      <p className="text-xs text-gray-500">Nature of Offence</p>
                      <p className="text-xs text-gray-900">{investigation.nature_of_offence || '-'}</p>
                    </div>
                    <div className="flex items-center justify-between p-3 bg-gray-50/50 rounded-sm border border-gray-100">
                      <p className="text-xs text-gray-500">Source</p>
                      <p className="text-xs text-gray-900">{investigation.source_name || '-'}</p>
                    </div>
                  </div>
                </div>
              </div>
                      ...
                      <div key={taxpayer.id || index} className="mb-4 last:mb-0">
                        <div className="grid grid-cols-3 gap-4">
                          <div className="flex items-center justify-between p-3 bg-gray-50/50 rounded-sm border border-gray-100">
                            ...
                            <p className="text-xs text-gray-900">{taxpayer.gstin || '-'}</p>
                          </div>
                          <div className="flex items-center justify-between p-3 bg-gray-50/50 rounded-sm border border-gray-100">
                            <p className="text-xs text-gray-500">Name</p>
                            <p className="text-xs text-gray-900">{taxpayer.name || '-'}</p>
                          </div>
                          <div className="flex items-center justify-between p-3 bg-gray-50/50 rounded-sm border border-gray-100">
                            <p className="text-xs text-gray-500">Trade Name</p>
                            <p className="text-xs text-gray-900">{taxpayer.trade_name || '-'}</p>
                          </div>
                          <div className="flex items-center justify-between p-3 bg-gray-50/50 rounded-sm border border-gray-100">
                            <p className="text-xs text-gray-500">Email</p>
                            <p className="text-xs text-gray-900">{taxpayer.email || '-'}</p>
                          </div>
                          <div className="flex items-center justify-between p-3 bg-gray-50/50 rounded-sm border border-gray-100">
                            <p className="text-xs text-gray-500">Phone</p>
                            <p className="text-xs text-gray-900">{taxpayer.phone_number || '-'}</p>
                          </div>
                          <div className="flex items-center justify-between p-3 bg-gray-50/50 rounded-sm border border-gray-100">
                            <p className="text-xs text-gray-500">Division</p>
                            <p className="text-xs text-gray-900">{taxpayer.division_name || '-'}</p>
                          </div>
                          <div className="flex items-center justify-between p-3 bg-gray-50/50 rounded-sm border border-gray-100">
                            <p className="text-xs text-gray-500">Range</p>
                            <p className="text-xs text-gray-900">{taxpayer.range_name || '-'}</p>
                          </div>
                          <div className="flex items-center justify-between p-3 bg-gray-50/50 rounded-sm border border-gray-100">
                            <p className="text-xs text-gray-500">Address</p>
                            <p className="text-xs text-gray-900">{taxpayer.address || '-'}</p>
                          </div>
                        </div>
                      </div>
                    ))}
