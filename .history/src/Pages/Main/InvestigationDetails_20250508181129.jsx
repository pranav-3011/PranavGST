                ...
                <div className="p-4">
                  <div className="grid grid-cols-3 gap-4">
                    ...
                    <div className="flex items-center gap-3 p-3 bg-gray-50 rounded-lg">
                      <Calendar className="text-gray-500" size={18} />
                      <div>
                        <p className="text-sm text-gray-600">Period Involved</p>
                        <p className="font-medium">{investigation.period_involved ? new Date(investigation.period_involved).toLocaleDateString() : '-'}</p>
                      </div>
                    </div>
                    <div className="flex items-center gap-3 p-3 bg-gray-50 rounded-lg">
