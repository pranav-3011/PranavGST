        ...
        {summonedPersons.map((person, index) => (
          ...
          >
            <div className="p-4">
              ...
              {/* Summons Table */}
              {person.summons && person.summons.length > 0 ? (
                <div className="mt-4">
                  <div className="overflow-hidden rounded-lg border border-gray-200">
                    <table className="min-w-full divide-y divide-gray-200">
                      ...
                      <tbody className="bg-white divide-y divide-gray-200">
                        {person.summons.map((summon, idx) => (
                          <tr key={idx} className="hover:bg-gray-50">
                            <td className="px-3 py-2 whitespace-nowrap text-xs text-gray-600">
                              {summon.date_of_issuing ? new Date(summon.date_of_issuing).toLocaleDateString() : "-"}
                            </td>
                            <td className="px-3 py-2 whitespace-nowrap text-xs text-gray-600">
                              {summon.din_number}
                            </td>
                            <td className="px-3 py-2 whitespace-nowrap text-xs">
                              <div className="flex items-center justify-center">
                                <span className={`inline-flex items-center px-2 py-0.5 rounded-full text-xs font-medium
                                  ${summon.appeared ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800'}`}>
                                  {summon.appeared ? 'Appeared' : 'Not Appeared'}
                                </span>
                              </div>
                            </td>
                ...
                <div className="mt-4 py-3 text-center text-sm text-gray-500 bg-gray-50 rounded-lg">
