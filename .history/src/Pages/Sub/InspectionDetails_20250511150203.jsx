...
import { Plus, ArrowLeft, FileText, Calendar, User, Building, MapPin, Phone, Mail, X, Trash2, Edit } from "lucide-react";
...
const InspectionDetails = ({ fileNumber }) => {
  ...
  const handleEditInspection = () => {
    setFormData({
      ...
      competency: selectedInspection.competency || "",
      post: selectedInspection.post || "",
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="flex items-center gap-3 p-3 bg-gray-50 rounded-lg">
                ...
                <div>
                  ...
                  <p className="font-medium">{selectedInspection.competency || "-"}</p>
                </div>
              </div>
              <div className="flex items-center gap-3 p-3 bg-gray-50 rounded-lg">
                <FileText className="text-gray-500" size={18} />
                <div>
                  ...
                  <p className="font-medium">{selectedInspection.post || "-"}</p>
                </div>
              </div>
          ...
          >
            ...
            <div onClick={() => handleViewInspection(inspection.id)} className="h-full">
              ...
              <div className="space-y-2">
                ...
                <div className="flex items-center gap-2 text-sm text-gray-600">
                  <FileText size={16} />
                  <span>{inspection.competency || "-"}</span>
                </div>
                <div className="flex items-center gap-2 text-sm text-gray-600">
                  <User size={16} />
