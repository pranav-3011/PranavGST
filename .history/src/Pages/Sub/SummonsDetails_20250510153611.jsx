      ...
      <div className="max-w-4xl mx-auto p-4">
        <div className="mb-4 flex justify-between">
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              onClick={() => {
                // Set form data for new summons and show add form
                setFormData({
                  ...selectedPerson,
                  summons: [{
                    date_of_issuing: "",
              ...
              <div className="space-y-4">
                {selectedPerson.summons.map((summon, index) => (
                  <div key={summon.id || index} 
                    ...
                    <div className="bg-gray-50 p-3">
                      ...
                      <div className="flex items-center gap-2">
                        {!summon.appeared && (
                          <button
                            onClick={() => {
                              // Handle marking as appeared
                              const updatedSummons = [...selectedPerson.summons];
                              updatedSummons[index] = { ...summon, appeared: true };
                              handleUpdatePerson({
                                preventDefault: () => {},
                                target: { value: { ...selectedPerson, summons: updatedSummons } }
                              });
                            }}
                          ...
                          <>
                            <button
                              onClick={() => {
                                ...
                                updatedSummons[index] = { ...summon, statements: updatedStatements };
                                handleUpdatePerson({
                                  preventDefault: () => {},
                                  target: { value: { ...selectedPerson, summons: updatedSummons } }
                                });
                            ...
                            <button
                              onClick={() => {
                                ...
                                const updatedSummons = [...selectedPerson.summons];
                                const lastStatement = summon.statements[summon.statements.length - 1];
                                const updatedDocuments = [...(lastStatement.documents || []), {
                                  document_name: "",
                                  document_type: "",
                                  document_number: ""
                                }];
                                lastStatement.documents = updatedDocuments;
                                updatedSummons[index] = { ...summon, statements: [...summon.statements] };
                                handleUpdatePerson({
                                  preventDefault: () => {},
                                  target: { value: { ...selectedPerson, summons: updatedSummons } }
                                });
                    ...
                    {/* Statements Section - Only shown if appeared is true */}
                            ...
                            <div className="flex items-center justify-between mb-3">
                              <div className="flex items-center gap-4">
                                ...
                                <div className="flex items-center gap-2">
                                  ...
                                  <span className="text-sm">{statement.statement_recorded_by}</span>
                                </div>
                              </div>
                            </div>
