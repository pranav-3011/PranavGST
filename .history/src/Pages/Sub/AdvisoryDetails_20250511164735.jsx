    ...
    <form onSubmit={onSubmit} className="p-4">
      <div className="space-y-6">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-1">
              Advisory Due Date <span className="text-red-500">*</span>
            </label>
            <input
              type="date"
              name="advisory_due_date"
              value={formData.advisory_due_date}
              onChange={handleChange}
              className="w-full border border-gray-300 rounded-md px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 date-picker"
              onFocus={(e) => e.target.showPicker()}
              required
...
const AdvisoryDetails = ({ fileNumber }) => {
  ...
  const handleEditAdvisory = () => {
    setFormData({
      ...
      advisory_due_date: selectedAdvisory.advisory_due_date || "",
          ...
          <div className="p-4">
            ...
            <div className="mt-6">
              ...
              <div className="p-4 bg-blue-50 rounded-lg">
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <p className="font-semibold">Total Advisory Amount</p>
                </div>
                <p className="text-2xl font-bold text-blue-600">
                  {formatAmount(selectedAdvisory.amount)}
                </p>
              </div>
            </div>
            ...
            <div className="mt-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                {selectedAdvisory.added_by && (
                  <div className="flex items-center gap-3 p-3 bg-gray-50 rounded-lg">
                    <Calendar className="text-gray-500" size={18} />
                    <div>
                      <p className="text-sm text-gray-600">Added By</p>
                      <p className="font-medium">{selectedAdvisory.added_by || "-"}</p>
                    </div>
                  </div>
                )}
                {selectedAdvisory.updated_by && (
                  <div className="flex items-center gap-3 p-3 bg-gray-50 rounded-lg">
                    <Calendar className="text-gray-500" size={18} />
                    <div>
                      <p className="text-sm text-gray-600">Updated By</p>
                      <p className="font-medium">{selectedAdvisory.updated_by || "-"}</p>
                    </div>
                  </div>
                )}
              </div>
            ...
            <div onClick={() => handleViewAdvisory(advisory.id)} className="h-full">
              ...
              <div className="space-y-2">
                ...
                <div className="flex items-center gap-2 text-sm text-gray-600">
                  <Calendar size={16} />
                  <span>
                    Due: {advisory.advisory_due_date
                      ? new Date(advisory.advisory_due_date).toLocaleDateString()
                      : "-"}
                  </span>
                </div>
                <div className="flex items-center gap-2 text-sm text-gray-600">
