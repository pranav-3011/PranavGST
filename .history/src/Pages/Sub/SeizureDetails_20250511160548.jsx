        ...
        <div className="bg-white rounded-xl shadow-md overflow-hidden border border-gray-200">
          ...
          <div className="bg-gradient-to-r from-blue-600 to-blue-800 p-6 text-white">
            <div className="flex justify-between items-center">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h2 className="text-sm uppercase tracking-wider font-semibold opacity-80">Seizure Reference</h2>
                  <p className="text-2xl font-bold">#{selectedSeizure.id}</p>
                </div>
              </div>
              <div className="flex flex-col items-end">
                <h3 className="text-sm font-medium opacity-90">Date of Seizure</h3>
            ...
            <div className="mt-4 flex items-center gap-3">
              <div className={`px-3 py-1 rounded-full text-xs font-medium ${
                selectedSeizure.seizure_type === "INSO2" 
                  ? "bg-green-200 text-green-800" 
                  : "bg-purple-200 text-purple-800"
              }`}>
                {selectedSeizure.seizure_type || "N/A"}
              </div>
          ...
          <div className="p-6">
            <div className="mb-8">
              ...
              <div className="grid grid-cols-1 gap-5">
                <div className="p-4 bg-gray-50 rounded-lg border border-gray-100">
                  <p className="text-sm font-medium text-gray-500 mb-1">Description of Goods</p>
                  <p className="text-gray-900">{selectedSeizure.description_of_goods || "-"}</p>
                </div>
                
                <div className="p-4 bg-gray-50 rounded-lg border border-gray-100">
                  <p className="text-sm font-medium text-gray-500 mb-1">Details of Seizure</p>
                  <p className="text-gray-900 whitespace-pre-line">{selectedSeizure.details_of_seizure || "-"}</p>
                </div>
              </div>
            </div>
            ...
            <div className="mb-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div className="p-4 bg-gray-50 rounded-lg border border-gray-100 flex flex-col">
                  <p className="text-sm font-medium text-gray-500">SI Unit</p>
                  <p className="text-lg font-medium text-gray-900 mt-auto">{selectedSeizure.si_unit || "-"}</p>
                </div>
                
                <div className="p-4 bg-gray-50 rounded-lg border border-gray-100 flex flex-col">
                  <p className="text-sm font-medium text-gray-500">Quantity</p>
                  <p className="text-lg font-medium text-gray-900 mt-auto">{selectedSeizure.quantity || "-"}</p>
                </div>
                
                <div className="p-4 bg-gray-50 rounded-lg border border-gray-100 flex flex-col">
                  <p className="text-sm font-medium text-gray-500">Model Mark</p>
                  <p className="text-lg font-medium text-gray-900 mt-auto">{selectedSeizure.model_mark || "-"}</p>
                </div>
              </div>
            </div>
            ...
            <div className="mb-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="p-4 bg-gray-50 rounded-lg border border-gray-100 flex flex-col">
                  <p className="text-sm font-medium text-gray-500">DIN on Authorization</p>
                  <p className="text-lg font-medium text-gray-900 mt-2">{selectedSeizure.din_on_authorization || "-"}</p>
                </div>
