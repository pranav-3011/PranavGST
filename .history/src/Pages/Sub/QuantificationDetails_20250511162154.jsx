...
import { Plus, ArrowLeft, FileText, Calendar, User, Edit, Trash2, DollarSign, X } from "lucide-react";
                ...
                <div>
                  ...
                  <p className="font-medium">
                    {selectedQuantification.added_on
                      ? new Date(selectedQuantification.added_on).toLocaleDateString()
                      : "-"}
                  </p>
                </div>
              </div>
            ...
            <div className="mt-6">
              <div className="p-4 bg-gray-50 rounded-lg">
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <p className="font-medium">Liability Detected For FY</p>
                </div>
                <p className="text-xl font-bold">{selectedQuantification.liability_detected_for_fy || "-"}</p>
              </div>
            </div>
              ...
              <div className="p-4 bg-blue-50 rounded-lg">
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <div>
                    ...
                    <p className="font-medium">{selectedQuantification.added_by || "-"}</p>
                  </div>
                </div>
              </div>
            </div>
  ...
  return (
    <div className="max-w-7xl mx-auto p-4">
      ...
      <div className="flex justify-between items-center mb-6">
        <h1 className="text-2xl font-bold text-gray-800">Quantification Records</h1>
        <CustomButton
          onClick={() => {
            resetFormData();
            setShowAddForm(true);
            ...
            <div onClick={() => handleViewQuantification(quantification.id)} className="h-full">
              <div className="flex items-center gap-3 mb-3">
                ...
                <div>
                  ...
                  <p className="font-medium">₹{quantification.amount || "N/A"}</p>
                </div>
              </div>
              <div className="space-y-2">
                ...
                <div className="flex items-center gap-2 text-sm text-gray-600">
                  <FileText size={16} />
                  <span className="truncate">FY: {quantification.liability_detected_for_fy || "N/A"}</span>
                </div>
                <div className="flex items-center gap-2 text-sm text-gray-600">
                  <User size={16} />
                  <span>Added by: {quantification.added_by || "N/A"}</span>
                </div>
              </div>
            </div>
          </div>
      ...
      {quantifications.length === 0 && (
        <div className="text-center py-8">
          <p className="text-gray-600">No quantification records found</p>
          <CustomButton
