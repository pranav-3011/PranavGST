...
const InspectionDetails = ({ fileNumber }) => {
  ...
  // Modified version of the competency field for the edit form
  const CompetencyField = ({ value, onChange }) => {
    return (
      <div className="relative">
        ...
        <div className="relative">
          <input
            ...
            onBlur={() => setTimeout(() => setShowCompetencyDropdown(false), 200)}
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200">
          ...
          <form onSubmit={handleUpdateInspection} className="p-4">
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <CompetencyField value={formData.issued_by} onChange={handleChange} />
                 <InputBox
