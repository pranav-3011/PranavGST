      ...
      <div className="max-w-4xl mx-auto p-4">
        ...
        <div className="bg-white rounded shadow-sm border border-gray-200">
          <div className="p-3 border-b border-gray-200">
            <h2 className="text-md font-semibold text-gray-900">Quantification Details</h2>
          ...
          <div className="p-3">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
              <div className="flex items-center gap-2 p-2 bg-gray-50 rounded">
                ...
                <div>
                  <p className="text-xs text-gray-600">Date of Quantification</p>
              ...
              <div className="flex items-center gap-2 p-2 bg-gray-50 rounded">
                ...
                <div>
                  ...
                  <p className="text-sm font-medium">{selectedQuantification.amount || "-"}</p>
                </div>
              </div>
              <div className="flex items-center gap-2 p-2 bg-gray-50 rounded">
                <FileText className="text-gray-500" size={16} />
                <div>
                  <p className="text-xs text-gray-600">Liability Detected For FY</p>
                  <p className="text-sm font-medium">{selectedQuantification.liability_detected_for_fy || "-"}</p>
                </div>
              </div>
              <div className="flex items-center gap-2 p-2 bg-gray-50 rounded">
                <FileText className="text-gray-500" size={16} />
                <div>
                  <p className="text-xs text-gray-600">Investigation ID</p>
                  <p className="text-sm font-medium">{selectedQuantification.investigation || "-"}</p>
                </div>
              </div>
            </div>
          </div>
  ...
  if (showAddForm) {
    return (
      <div className="max-w-4xl mx-auto p-4">
        ...
        <div className="bg-white rounded shadow-sm border border-gray-200">
          <div className="p-3 border-b border-gray-200">
            <h2 className="text-md font-semibold text-gray-900 flex items-center gap-1">
              <Plus size={16} className="text-blue-600" />
              Add New Quantification
            </h2>
          </div>
          <form onSubmit={handleAddQuantification} className="p-3">
            <div className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                <div>
                  ...
                  <input
                    ...
                    value={formData.date_of_quantification}
                    onChange={handleChange}
                    className="w-full border border-gray-300 rounded px-3 py-1.5 text-sm focus:outline-none focus:ring-1 focus:ring-blue-500 focus:border-blue-500 date-picker"
                    onFocus={(e) => e.target.showPicker()}
                    required
                  />
                </div>
              ...
              <div className="flex justify-end space-x-3 mt-4">
                ...
                <CustomButton type="submit" variant="blue" className="text-xs py-1 px-2">
                  Add
                </CustomButton>
              </div>
            </div>
  ...
  return (
    <div className="max-w-6xl mx-auto p-4">
      ...
      <div className="mb-4 flex justify-between items-center">
        <h1 className="text-lg font-semibold text-gray-900">Quantification Details</h1>
        <CustomButton
      ...
      {quantifications.length === 0 ? (
        <div className="bg-white rounded shadow-sm border border-gray-200 p-6 text-center">
          <p className="text-gray-500 text-sm">No quantification records found.</p>
          <CustomButton
            onClick={() => setShowAddForm(true)}
            variant="blue"
