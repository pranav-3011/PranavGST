            ...
            <button
              onClick={async () => {
                try {
                  ...
                  const updatedPerson = {
                    ...selectedPerson,
                    summons: [...selectedPerson.summons, newSummons]
                  };
                  ...
                  <div key={summon.id || index} 
                    ...
                    {editingStatement?.summonsIndex === index && (
                      <div className="p-3 border-t border-gray-200 bg-gray-50">
                        <div className="mb-3 text-sm font-medium text-gray-700">Add New Statement</div>
                    ...
                    {/* Statements Section */}
                    {summon.appeared && summon.statements && summon.statements.length > 0 && (
                      <div className="p-3 border-t border-gray-200">
                        <div className="text-sm font-medium text-gray-700 mb-3">
                          Recorded Statements ({summon.statements.length})
                        </div>
                        {summon.statements.map((statement, stIndex) => (
                          <div key={statement.id || stIndex} 
                            className="bg-white rounded-lg p-3 mb-3 last:mb-0 border-l-4 border-blue-500 shadow-sm hover:shadow-md transition-shadow">
                            {/* Statement Header */}
                            <div className="flex items-center justify-between mb-3 border-b border-gray-100 pb-2">
                              <div className="flex items-center gap-4">
                                ...
                                <div className="flex items-center gap-2">
                                  ...
                                  <span className="text-sm text-gray-600">
                                    Recorded by: {statement.statement_recorded_by}
                                  </span>
                                </div>
                              </div>
                              ...
                              <button
                                ...
                                className="text-sm px-3 py-1 bg-purple-100 text-purple-700 rounded-full hover:bg-purple-200 flex items-center gap-1"
                              >
                                <Plus size={14} />
                                Add Document
                              </button>
                            ...
                            {statement.documents && statement.documents.length > 0 && (
                              <div className="bg-gray-50 rounded-lg p-2">
                                <div className="flex items-center gap-2 text-xs font-medium text-gray-500 mb-2">
                                  <FileText size={14} />
                                  Attached Documents ({statement.documents.length})
                                </div>
