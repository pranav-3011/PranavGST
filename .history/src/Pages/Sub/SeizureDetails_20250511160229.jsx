        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200">
          ...
          <div className="p-4">
            ...
            {(selectedSeizure.ins_05_release_date || selectedSeizure.ins_05_details_of_release) && (
              <div className="mt-6 border border-gray-200 rounded-lg p-4">
                <h3 className="text-lg font-semibold text-gray-900 mb-4">INSO5 Details</h3>
                <div className="grid grid-cols-2 gap-4">
                  ...
                  {selectedSeizure.ins_05_details_of_release && (
                    <div className="col-span-2 flex items-center gap-3 p-3 bg-gray-50 rounded-lg">
                      <FileText className="text-gray-500" size={18} />
                      <div>
                        <p className="text-sm text-gray-600">Details of Release</p>
                        <p className="font-medium whitespace-pre-line">{selectedSeizure.ins_05_details_of_release}</p>
                      </div>
                    </div>
                  )}
                </div>
