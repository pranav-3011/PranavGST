...
// Move SearchForm outside of SearchDetails component
const SearchForm = ({ onSubmit, submitButtonText, formData, handleChange, handleOfficerChange, addOfficer, removeOfficer }) => (
    ...
    <div className="max-w-7xl mx-auto p-4">
      ...
      <div className="flex justify-between items-center mb-6">
        ...
        <CustomButton
          ...
          className="bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded-md font-medium transition-colors flex items-center gap-2 text-sm"
        >
          <Plus size={16} />
          Add New Search
        </CustomButton>
