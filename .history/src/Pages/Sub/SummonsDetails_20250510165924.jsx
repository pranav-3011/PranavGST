                ...
                <table className="w-full">
                  <thead>
                    <tr className="bg-gray-50 border-y border-gray-200">
                      ...
                      <th className="py-3 px-4 text-left text-sm font-medium text-gray-500">Date of Issuing</th>
                      <th className="py-3 px-4 text-left text-sm font-medium text-gray-500">Summons For Date</th>
                      <th className="py-3 px-4 text-left text-sm font-medium text-gray-500">DIN Number</th>
                      <th className="py-3 px-4 text-left text-sm font-medium text-gray-500">Issued By</th>
                    ...
                    {selectedPerson.summons.map((summon, index) => (
                      <React.Fragment key={summon.id || index}>
                        <tr className="border-b border-gray-100 hover:bg-gray-50">
                          ...
                          <td className="py-3 px-4 text-sm">{summon.din_number}</td>
                          <td className="py-3 px-4 text-sm">{summon.issued_by}</td>
                          <td className="py-3 px-4">
