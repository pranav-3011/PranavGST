                      ...
                      <div className="p-3 border-t border-gray-200">
                        ...
                        {summon.statements.map((statement, stIndex) => (
                          <div key={statement.id || stIndex} 
                            className="bg-white rounded-lg p-3 mb-3 last:mb-0 border-l-4 border-blue-500 shadow-sm">
                            <div className="flex items-center justify-between mb-3">
                              ...
                              <button
                                ...
                                className="text-sm px-3 py-1.5 bg-purple-100 text-purple-700 rounded-md hover:bg-purple-200 flex items-center gap-1"
                              >
                                <Plus size={14} />
                                Add Document
                              </button>
