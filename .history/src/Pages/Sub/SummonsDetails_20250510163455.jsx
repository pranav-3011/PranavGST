...
const SummonsDetails = ({ fileNumber }) => {
  ...
  // Helper function to format DRF errors
  const formatDRFErrors = (error) => {
  ...
  const fetchSummonedPersons = async () => {
    try {
      ...
      const errorMessage = formatDRFErrors(error);
                    ...
                    <div className="bg-gray-50 p-3">
                      ...
                      <div className="flex items-center gap-2">
                        <button
                          onClick={async () => {
                            try {
                              await handleToggleAppeared(summon, index);
                            } catch (error) {
                          ...
                          <div className="p-4 border-t border-gray-200 bg-blue-50">
                            ...
                            <div className="flex justify-end gap-2">
                              ...
                              <button
                                onClick={async () => {
                                  try {
                                    await handleAddStatement(summon, index, newStatementData);
                                  } catch (error) {
                                      ...
                                      <div className="mb-4 bg-purple-50 rounded-lg p-4 border border-purple-100">
                                        ...
                                        <div className="flex justify-end gap-2">
                                          ...
                                          <button
                                            onClick={async () => {
                                              try {
                                                await handleAddDocument(summon, index, statement, stIndex, newDocumentData);
                                              } catch (error) {
