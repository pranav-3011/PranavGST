      ...
      <div className="max-w-4xl mx-auto p-4">
        <div className="mb-4">
          <button
            ...
            className="flex items-center text-gray-600 pointer-cursor hover:underline"
          >
            <ArrowLeft size={20} className="mr-2" />
            Back to List
          </button>
      ...
      <div className="max-w-4xl mx-auto p-4">
        <div className="mb-4 flex justify-between">
          <button
            ...
            className="flex items-center text-gray-600 hover:underline pointer-cursor"
          >
            <ArrowLeft size={20} className="mr-2" />
            Back to List
          </button>
          <div className="flex items-center gap-3">
            ...
            <button
              ...
              className="flex items-center gap-2 px-3 py-2 bg-[#e6ecf7] text-[#00256c] rounded-md hover:bg-[#cfdcf0]"
          ...
          <div className="p-4 border-b border-gray-200">
            <div className="flex items-center gap-4">
              <div className="p-2 bg-indigo-100 rounded-lg">
                <User className="text-[#00256c]" size={24} />
              </div>
              <div>
                ...
                <table className="w-full">
                    ...
                    <tr className="bg-indigo-50 border-y border-gray-200">
                      ...
                      <th className="py-3 px-4 text-left">
                        <div className="flex items-center gap-2">
                          ...
                          <span className="text-sm font-medium text-gray-600">Date of Issuing</span>
                        </div>
                      </th>
                      <th className="py-3 px-4 text-left">
                        <div className="flex items-center gap-2">
                          <Calendar size={16} className="text-gray-500" />
                          <span className="text-sm font-medium text-gray-600">Summons For Date</span>
                        </div>
                      </th>
                      <th className="py-3 px-4 text-left">
                        <div className="flex items-center gap-2">
                          <Hash size={16} className="text-gray-500" />
                          <span className="text-sm font-medium text-gray-600">DIN Number</span>
                        </div>
                      </th>
                      <th className="py-3 px-4 text-left">
                        <div className="flex items-center gap-2">
                          <User size={16} className="text-gray-500" />
                          <span className="text-sm font-medium text-gray-600">Issued By</span>
                        </div>
                      </th>
                      <th className="py-3 px-4 text-left">
                  ...
                  <tbody>
                    {selectedPerson.summons.map((summon, index) => (
                      <React.Fragment key={summon.id || index}>
                        <tr className="border-b border-gray-100 hover:bg-gray-50">
                          ...
                          <td className="py-3 px-4">
                            <span className="text-sm text-gray-900">{summon.din_number}</span>
                          </td>
                          <td className="py-3 px-4">
                            <span className="text-sm text-gray-900">{summon.issued_by}</span>
                          </td>
                          <td className="py-3 px-4">
                            <div className={`flex items-center gap-2 ${
                              summon.appeared ? 'text-green-600' : 'text-red-600'
                            }`}>
                              <div className={`w-2 h-2 rounded-full ${
                                summon.appeared ? 'bg-green-500' : 'bg-red-500'
                              }`} />
                          ...
                          <td className="py-3 px-4">
                            <div className="flex items-center gap-2">
                              <button
                                onClick={async () => {
                                  try {
                                    ...
                                    toast.error(error.message || "Failed to update appeared status");
                                  }
                                }}
                              ...
                              >
                                {summon.appeared ? 'Mark Not Appeared' : 'Mark Appeared'}
                              </button>
                                          ...
                                          <div key={statement.id || stIndex} 
                                            ...
                                            <div className="flex items-center justify-between mb-4">
                                              ...
                                              <button
                                                ...
                                                className="flex items-center gap-1 text-[12px] px-2 py-1  text-purple-700 rounded-md hover:bg-purple-200"
                                              >
                                                <Plus size={14} />
                                                Add Document
                                              </button>
    ...
    <div className="max-w-7xl mx-auto p-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        {summonedPersons.map((person, index) => (
          <div
            key={person.id}
            className="bg-white rounded-lg shadow-sm border border-gray-200 hover:border-blue-300 transition-all cursor-pointer group"
            ...
            <div className="p-4">
              <div className="flex items-start justify-between">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h3 className="font-medium text-gray-900 line-clamp-2">{person.name_of_person_or_firm}</h3>
        ...
        <div className="mt-6">
          <div className="flex justify-between items-center mb-4">
            ...
            <button
              type="button"
              onClick={addSummons}
              className="inline-flex items-center px-3 py-1 border border-transparent text-sm leading-4 font-medium rounded-md text-blue-700 bg-indigo-100 hover:bg-blue-200 focus:outline-none focus:ring-2 focus:ring-offset-1 focus:ring-blue-500"
            >
