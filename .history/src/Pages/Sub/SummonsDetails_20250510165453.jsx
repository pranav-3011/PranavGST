  ...
  if (selectedPerson) {
    return (
      <div className="max-w-4xl mx-auto p-4">
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200">
          <div className="p-4 border-b border-gray-200">
            <h3 className="text-lg font-medium text-gray-900">Summons List</h3>
          </div>
            ...
            <table className="w-full">
              <thead>
                <tr className="bg-gray-50 border-b border-gray-200 text-left">
                  ...
                  <th className="p-4 text-sm font-medium text-gray-600">Date of Issuing</th>
                  <th className="p-4 text-sm font-medium text-gray-600">Summons For Date</th>
                  <th className="p-4 text-sm font-medium text-gray-600">DIN Number</th>
                  <th className="p-4 text-sm font-medium text-gray-600">Issued By</th>
              ...
              <tbody>
                {selectedPerson.summons && selectedPerson.summons.length > 0 ? (
                  selectedPerson.summons.map((summon, index) => (
                    <tr key={summon.id || index} className="border-b border-gray-100 last:border-0">
                      <td className="p-4">
                      ...
                      <td className="p-4 text-sm text-gray-900">{summon.din_number}</td>
                      <td className="p-4 text-sm text-gray-900">{summon.issued_by}</td>
                      <td className="p-4">
        ...
        {/* Statements and Documents sections remain the same */}
        {selectedPerson.summons && selectedPerson.summons.map((summon, index) => (
          !collapsedSummons[index] && (
            <div key={`details-${summon.id || index}`} className="mt-4">
              {/* New Statement Form */}
