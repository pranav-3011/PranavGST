...
const Sidebar = () => {
  ...
  return (
    <>
      ...
      {/* Sidebar */}
      <div
        className={`fixed lg:static h-full overflow-y-auto w-60 bg-gradient-to-b from-[#f5f5f8] via-[#eff1f7] to-[#eae6f0]  flex flex-col z-40 transform transition-all duration-300 ease-in-out ${
