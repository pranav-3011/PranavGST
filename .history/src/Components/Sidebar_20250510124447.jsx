...
const Sidebar = () => {
  ...
  return (
    <>
      ...
      {/* Sidebar */}
      <div
        className={`fixed lg:static h-full overflow-y-auto w-60 bg-gradient-to-tl from-[#ffffff] via-[#f0f1f5] to-[#dfe1e9] shadow-md flex flex-col z-40 transform transition-all duration-300 ease-in-out ${
