...
const Sidebar = () => {
  ...
  return (
    <>
      ...
      {/* Sidebar */}
      <div
        className={`fixed lg:static h-full overflow-y-auto w-60 bg-gradient-to-br from-[#ffffff] via-[#9ba4ca] to-[#fbfcfd] shadow-md flex flex-col z-40 transform transition-all duration-300 ease-in-out ${
