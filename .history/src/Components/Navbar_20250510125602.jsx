...
const Navbar = () => {
  ...
  return (
    <div className="w-full h-16 bg-violet-50 text-gray-800 flex items-center justify-between px-4 sm:px-6 shadow-md border-b border-gray-100 sticky top-0 z-30">
