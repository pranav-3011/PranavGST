    ...
    <>
      ...
      >
        ...
        <div className="p-6 border-t border-blue-100 mt-auto">
          <button
            className="w-full flex items-center justify-center gap-2 px-4 py-3 text-sm font-medium text-white bg-[#11486b] hover:from-blue-700 hover:to-blue-800 rounded-xl transition-all duration-200 shadow-sm"
            onClick={() => {
