    ...
    <>
      ...
      >
        ...
        <div className="p-6 border-t border-blue-100 mt-auto">
          <button
            className="w-full flex items-center justify-center gap-2 px-4 py-3 text-sm font-medium text-white bg-[#00256c] hover:bg-[#0039a6] rounded-md transition-all duration-200 shadow-sm"
            onClick={() => {
