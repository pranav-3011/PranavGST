...
const Sidebar = () => {
  ...
  return (
    <>
      ...
      {/* Sidebar */}
      <div
        className={`fixed lg:static h-full overflow-y-auto w-60 bg-gradient-to-bt from-[#e6ecf7] via-[#ccd8ee] to-[#00256c]
 shadow-sm flex flex-col z-40 transform transition-all duration-300 ease-in-out ${
