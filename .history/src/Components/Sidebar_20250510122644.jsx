...
const Sidebar = () => {
  ...
  return (
    <>
      ...
      {/* Sidebar */}
      <div
        className={`fixed lg:static h-full overflow-y-auto w-60 bg-gradient-to-b from-[#f0f4fb] via-[#d6e0f2] to-[#d1dbec] shadow-sm flex flex-col z-40 transform transition-all duration-300 ease-in-out ${
