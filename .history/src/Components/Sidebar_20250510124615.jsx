...
const Sidebar = () => {
  ...
  return (
    <>
      ...
      {/* Sidebar */}
      <div
        className={`fixed lg:static h-full overflow-y-auto w-60 bg-gradient-to-br from-[#ebebf0] via-[#f1f2f7] to-[#fbfcfd] shadow-md flex flex-col z-40 transform transition-all duration-300 ease-in-out ${
