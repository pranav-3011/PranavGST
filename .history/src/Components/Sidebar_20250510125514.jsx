...
import logo from "../assets/customsLogo.png";
...
const Sidebar = () => {
  ...
  return (
    <>
      ...
      {/* Sidebar */}
      <div
        className={`fixed lg:static h-full overflow-y-auto w-60 bg-gradient-to-b from-[#f5f5f8] via-[#eff1f7] to-[#eae6f0] shadow-md flex flex-col z-40 transform transition-all duration-300 ease-in-out ${
          isOpen ? "translate-x-0" : "-translate-x-full lg:translate-x-0"
        }`}
      >
        <div className="py-4 px-2 border-b border-blue-100">
            ...
            {navItems.map((item) => {
              ...
              return (
                <Link
                  ...
                  className={`flex items-center mb-2 justify-between px-4 py-3 rounded-md text-sm font-medium transition-all duration-200 group ${
                    isActive
        ...
        <div className="p-6 border-t border-blue-100 mt-auto">
          <button
            className="w-full flex items-center justify-center gap-2 px-4 py-3 text-sm font-medium text-white bg-[#00256c] cursor-pointer hover:bg-[#0039a6] rounded-md transition-all duration-200 shadow-sm"
            onClick={() => {
