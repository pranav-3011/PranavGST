...
const Sidebar = () => {
  ...
  return (
    <>
      ...
      {/* Sidebar */}
      <div
        className={`fixed lg:static h-full overflow-y-auto w-60 bg-gradient-to-b from-[#abb7ca] via-[#dee5f3] to-[#f8f9fa] shadow-md flex flex-col z-40 transform transition-all duration-300 ease-in-out ${
