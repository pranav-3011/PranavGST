...
const Sidebar = () => {
  ...
  return (
    <>
      ...
      {/* Sidebar */}
      <div
        className={`fixed lg:static h-full overflow-y-auto w-60 bg-gradient-to-b from-[#f0f4fb] via-[#dee5f3] to-[#eff0f3] shadow-md flex flex-col z-40 transform transition-all duration-300 ease-in-out ${
